class UploadImagesController < ApplicationController
  before_action :set_upload_image, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    if @upload_image.save
      redirect_to @upload_image, notice: 'Upload image was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @upload_image.update(upload_image_params)
      redirect_to @upload_image, notice: 'Upload image was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to upload_images_url, notice: 'Upload image was successfully destroyed.'
  end
  ...
  private
    ...
    def upload_image_params
      params.require(:upload_image).permit(:image, :topstyle, :topcolor, :bottomstyle, :bottomcolor, :shoestyle, :shoecolor, :vibe)
    end
end
